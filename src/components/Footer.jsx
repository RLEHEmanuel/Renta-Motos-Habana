      ...
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          <div className="animate-slide-in-left">
            <h3 className="text-xl font-bold mb-4 text-yellow-400 font-sans">Contacto</h3>
            <p className="text-gray-400 font-sans">📍 La Habana, Cuba</p>
            <p className="text-gray-400 font-sans">📱 +53 (7) 123-4567</p>
            <p className="text-gray-400 font-sans">✉️ info@motorentashabana.com</p>
          </div>
          ...
          <div className="animate-slide-in-right" style={{ animationDelay: '0.1s' }}>
            <h3 className="text-xl font-bold mb-4 text-yellow-400 font-sans">Síguenos</h3>
        ...
        <div className="border-t border-gray-700 pt-8 text-center text-gray-400 font-sans">
